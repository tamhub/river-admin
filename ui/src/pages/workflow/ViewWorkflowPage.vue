    ...
    <v-container v-if="initialized">
      ...
      <div class="flex w-full">
        <v-flex xxs12 md3>
          <v-container>
            <div
              class="  rounded-[20px] gap-5 overflow-x-hidden flex flex-col w-full h-full"
            >
              <div
                class="container flex flex-col items-start justify-start flex-none w-full gap-6"
              >
                <svg
                  width="64"
                  height="64"
                ...
                >
                  ...
                  />
                  <path
                    d="M57.3335 33.3333C56.0002 35.9999 46.6668 38.6666 37.3335 37.3333"
                    stroke="#5E45FF"
                    stroke-width="2"
                  />
                  <path
                    d="M57.3335 21.3333C56.0002 23.9999 46.6668 26.6666 37.3335 25.3333"
                    stroke="#5E45FF"
                    stroke-width="2"
                  />
                  <path
                ...
                <h2 style="color: #121722;" class="text-2xl font-bold">
                  FMS Workflow
                </h2>
                <p style="color: #121722;">
                  The workflow of the exiting FMS aims to fund the translated
                  applications through an expense approval cycle.
                </p>
              </div>
              ...
              <ul class="flex flex-col w-full gap-1">
                <li>
                  <router-link
                    class="flex items-center justify-start gap-2 py-3"
                    style="color: #121722;"
                    :to="`/workflow/edit/rules/${workflow.id}/`"
                  >
                    <svg
                      width="16"
                      height="16"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clip-path="url(#clip0_24_2784)">
                        <path
                          d="M11.3335 2C11.5086 1.8249 11.7165 1.68601 11.9452 1.59125C12.174 1.49649 12.4192 1.44772 12.6668 1.44772C12.9145 1.44772 13.1597 1.49649 13.3884 1.59125C13.6172 1.68601 13.8251 1.8249 14.0002 2C14.1753 2.1751 14.3142 2.38297 14.4089 2.61174C14.5037 2.84051 14.5524 3.08571 14.5524 3.33333C14.5524 3.58096 14.5037 3.82615 14.4089 4.05493C14.3142 4.2837 14.1753 4.49157 14.0002 4.66667L5.00016 13.6667L1.3335 14.6667L2.3335 11L11.3335 2Z"
                          stroke="#A0A2A7"
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M13.7268 8.94L8.94683 13.72C8.823 13.844 8.67595 13.9423 8.51408 14.0094C8.35222 14.0765 8.17872 14.111 8.0035 14.111C7.82828 14.111 7.65477 14.0765 7.49291 14.0094C7.33105 13.9423 7.18399 13.844 7.06016 13.72L1.3335 8V1.33333H8.00016L13.7268 7.06C13.9752 7.30982 14.1146 7.64775 14.1146 8C14.1146 8.35225 13.9752 8.69018 13.7268 8.94V8.94Z"
                        stroke="#A0A2A7"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M4.6665 4.66667H4.67317"
                        stroke="#A0A2A7"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                ...
                <li>
                  <router-link
                    class="flex items-center justify-start gap-2 py-3"
                    style="color: #121722;"
                    :to="`/workflow-object/${workflow.id}/`"
                  >
                    <svg
                      width="16"
                      height="16"
                    ...
                    >
                      ...
                      />
                      <path
                        d="M9.3335 1.33333V5.33333H13.3335"
                        stroke="#A0A2A7"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
          ...
          return Promise.all(
            response.data.map((transition_meta) => {
              ...
              return Promise.all([
                ...
                console.log("sdfsjdfksdfjskdfkgskjdfgsdjfk", { transition });
                return transition;
              });
            })
          );
