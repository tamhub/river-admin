...
export class Transition {
  ...
  static of(id, workflow, source_state_id, destination_state_id, name) {
...
export class TransitionHook {
  ...
  to_create_request() {
    return {
      ...
      content_type: this.workflow_object_id
        ? this.workflow.content_type.id
        : null,
    };
  }
}
